...
%FFmpeg% -hide_banner -i "%~1" -vn -sn -dn -ac 2 -map 0:a:1 -c:a pcm_f32le -f wav - | %FFmpeg% -hide_banner -i - -vn -sn -dn -c:a libopus -b:a %Audio_Encode_Bitrate%k "%~dpn1_opus_2.mka" && del /q /f "%~dpn1_quality.mka"
