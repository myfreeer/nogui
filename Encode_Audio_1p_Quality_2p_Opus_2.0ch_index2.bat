...
%FFmpeg% -hide_banner -i "%~1" -vn -map 0:a:1 -af "pan=stereo| FL=FL+0.707107FC+0.707107BL+0.707107SL | FR=FR+0.707107FC+0.707107BR+0.707107SR" -c:a libopus -b:a %Audio_Encode_Bitrate%k "%~dpn1_opus_2.mka" && del /q /f "%~dpn1_quality.mka"
