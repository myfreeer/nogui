...
ffmpeg -hide_banner -i "%~1" -c:a pcm_f32le -f wav - | neroaacenc -q 0.25 -ignorelength -if - -of "%~dpn1_aac.m4a"
echo.

x264_64.exe --crf 25 --preset 8 -f -3:-3 -r 16 -b 16 -o "%~dpn1_crf.264" "%~1"
echo.
