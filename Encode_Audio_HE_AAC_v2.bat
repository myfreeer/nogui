@echo off
title Nogui HE_AAC v2 Audio Encoder
...
set Audio_Encoder_FDK_x64=fdkaac.exe
set Audio_Encoder_FDK_x86=fdkaac.exe
set Audio_Encode_Quality_FDK=3
rem Audio_Encode_Quality: 1, 2, 3, larger better
...
set Audio_Encoder_FDK=%Audio_Encoder_FDK_x86%
goto :Main

:x64
set FFmpeg=%FFmpeg_x64%
set Audio_Encoder_FDK=%Audio_Encoder_FDK_x64%
goto :Main

:Main
set /a args+=1
title Encoding %args% of %argC% - Nogui HE_AAC v2 Audio Encoder
if exist "%~dpn1_heaac.m4a" ren "%~dpn1_heaac.m4a" "%~dpn1_heaac%RANDOM%.m4a"
%FFmpeg% -hide_banner -i "%~1" -vn -dn -sn -c:a pcm_f32le -f wav - | %Audio_Encoder_FDK% -p29 -m%Audio_Encode_Quality_FDK% -I -o "%~dpn1_heaac.m4a" -
echo.
